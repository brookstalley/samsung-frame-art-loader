...
- [ ] Chunk 24: Map the set's power transitions, with the Apple TV in the loop — *hardware; the measurement needed an instrument, so the chunk ships `power_probe.py` and its tests*
