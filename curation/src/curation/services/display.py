...
class DisplayService:
    ...
    def wall_status(self, wall_id: str) -> HeartbeatReading:
        """Observe the heartbeat of the display serving one wall.
        ...
        wall no display has been pointed at yet, it is the correct one, and it is
        now sayable *about that wall* rather than about the installation.
        """
        self.get_wall(wall_id)
        return heartbeat.read(self._settings.heartbeat_path(wall_id))
